                ...
                using (reader = ado.ExecDataReaderProc("RNDLocation_READ", "RND", null))
                {
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            {
                                Value = Convert.ToString(reader["PlantState"]),
                                Text = Convert.ToString(reader["PlantDesc"]),
                                Selected = (WS.Plant == Convert.ToString(reader["PlantState"])) ? true : false,
                            });
                        }
                    }
                }
        ...
        public HttpResponseMessage Post(RNDWorkStudy workStudy)
        {
            ...
            try
            {
                ...
                if (workStudy.RecId > 0)
                {
                    ...
                    ado.ExecScalarProc("RNDWorkStudy_Update", "RND", new object[] { param1, param2, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16 });
                }
                else
                {
                    ado.ExecScalarProc("RNDWorkStudy_Insert", "RND", new object[] { param1, param2, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15 });
                }
            }
            catch (Exception ex)
            {
